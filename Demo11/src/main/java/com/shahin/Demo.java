...
@PropertySource("classpath:messages.properties") // Load properties file if i defined some properties in other file than application-local.properties, then we have to mention the file here
